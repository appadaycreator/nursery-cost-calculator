...
const SVC_URL = "https://appadaycreator.com/nursery-cost-calculator/";
const SVC_NAME = "保育園・幼稚園費用計算";

test.describe("保育園・幼稚園費用計算 - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("nursery-cost-calculator");
